...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const GOOGLE_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbyBBggnv-YqTVwjZTg9T0dIfQRXeOEHXBtyD0K1odqI6eAmCKEICw9fNK4Ofs2foyS0/exec'; // <--- ВАША URL
    ...
    if (productSelect && colorSelect && phoneInput && nameInput && submitButton && successPopup && closePopupButton && honeypotInput) {
